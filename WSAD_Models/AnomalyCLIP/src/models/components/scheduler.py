...
class WarmupCosineAnnealingLR(WarmupLR):
    def __init__(self, optimizer, total_epoch, successor=None, final_factor=0, warmup_epochs=0, warmup_powers=1, warmup_lrs=0, last_epoch=-1):
...
class _BaseWarmupScheduler(_LRScheduler):
    def __init__(self, optimizer, successor, warmup_epochs, total_epoch, last_epoch=-1, verbose=False):
...
class ConstantWarmupScheduler(_BaseWarmupScheduler):
    def __init__(self, optimizer, successor, warmup_epochs, cons_lr, total_epoch, last_epoch=-1, verbose=False):
