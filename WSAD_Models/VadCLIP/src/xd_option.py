...
parser.add_argument('--gt-path', default='list/gt_xd.npy')
parser.add_argument('--gt-segment-path', default='list/gt_segment_xd.npy')
parser.add_argument('--gt-label-path', default='list/gt_label_xd.npy')
