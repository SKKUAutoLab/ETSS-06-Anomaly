...
python -m src.eval --root_path "$root_path" --annotationfile_path "$annotationfile_path" --scores_dir "$scores_dir" --similarity_dir "$similarity_dir" --captions_dir "$captions_dir" --output_dir "$output_dir" --frame_interval "$frame_interval" --num_neighbors "$num_neighbors" --without_labels --visualize --video_fps "$video_fps"
