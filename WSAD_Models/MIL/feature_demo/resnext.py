...
# src: https://github.com/tomrunia/PyTorchConv3D/blob/master/models/resnext.py
...
class ResNeXt(nn.Module):
    def __init__(self, block, layers, shortcut_type='B', cardinality=32, num_classes=400, output_layers=[]):
        self.inplanes = 64
...
def generate_model():
    model = resnet101(num_classes=400, shortcut_type='B', cardinality=32, output_layers=[])
    model = model.cuda()
