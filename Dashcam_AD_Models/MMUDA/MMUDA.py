...
class MetaFrameWork(object):
    ...
    def init(self):
        ...
        self.train_loader = dataloader(self.dataset(mode='train', domains=self.source, force_cache=False, imgs_per_epoch=3000))
        ...
        self.target_loader_train = dataloader(target_dataset(root=ROOT + folder, mode='test'), batch_size=batch_size)
