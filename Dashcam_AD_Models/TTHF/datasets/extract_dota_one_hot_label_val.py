...
meta_data = json.load(
    open(os.path.join('data/DoTA', "metadata_val.json"), "rb"))
...
save_path = 'data/DoTA/ground_truth_demo/'
if not os.path.isdir(save_path):
    os.mkdir(save_path)
joblib.dump(one_hot_label_dict, os.path.join(save_path, 'val_one_hot_label.json'))
