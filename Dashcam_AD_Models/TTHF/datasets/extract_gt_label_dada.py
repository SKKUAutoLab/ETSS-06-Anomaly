...
root_path = 'data/DADA2000'  # path to DADA dataset label
...
if __name__=='__main__':
    ...
    if args.mode == 'train':
        video_file = 'data/DADA2000/train_file.json'
    elif args.mode == 'val':
        video_file = 'data/DADA2000/val_file.json'
    else:
        video_file = 'data/DADA2000/test_file.json'
    label_path = 'data/DADA2000'
    save_path = 'data/DADA2000/ground_truth_demo/'
